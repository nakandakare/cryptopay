...
export const NAVBAR_ITEMS = ['Market', 'Exchange', 'Tutorials', 'Wallets'];

export const CONTRACT_ADDRESS = '0x9E9223615070E604697251EF5225818d6aE30Fef';
export const CONTRACT_ABI = abi.abi;

export const STEPS = [
  { name: 'wallet', text: 'Connect your Decentralized Wallet on Crytpopay' },
  { name: 'world', text: 'Integrate the Cryptopay frame into your ecosystem' },
  { name: 'tokens', text: 'Choose your favorite crypto to make the transaction' },
  { name: 'thumbsUp', text: 'Send Crypto easily' }
];
